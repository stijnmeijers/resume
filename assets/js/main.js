...
let profilePicture = document.getElementById('pf')
...
// Function to call areaCv and Html2Pdf option s 
function generateResume(){
    html2pdf(areaCv, opt)
}

//funtion to swap id's
function swapId(inintial, replacement){
    document.getElementById(inintial).id = replacement
    // var element = document.getElementsByClassName(inintial)
    // element.classList.add(replacement)
    // document.getElementsByClassName(inintial).remove(inintial)
}
